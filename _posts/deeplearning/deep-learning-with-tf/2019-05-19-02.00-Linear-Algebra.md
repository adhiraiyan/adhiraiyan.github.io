...
- $V$ corresponds to to the eigenvectors of $A^{\top} A$
...
🔥 You can access the Code for this notebook in [GitHub](https://github.com/adhiraiyan/DeepLearningWithTF2.0) or launch an executable versions of this notebook using [Google Colab](https://colab.research.google.com/github/adhiraiyan/DeepLearningWithTF2.0/blob/master/notebooks/02.00-Linear-Algebra.ipynb). 🔥


***
### ️💛 Coming Up Next: Probability and Information Theory (06.02.2019)
